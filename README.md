...
Specifically,
* any css files you want to have to style your **JS Viz** should go into the css folder
* any static js files that are required to render the **JS Viz** should go here. 
